...
\begin{marginfigure}%
	\begin{center}
  \includegraphics[width=0.45\linewidth]{frazz-time.png}
%  \caption{Charlie Brown reflecting on Learning Performances}
  \label{fig:sc-pic}
	\end{center}
\end{marginfigure}
...
\begin{specweek}\endsemester\end{specweek}
