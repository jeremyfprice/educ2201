...
\begin{dayact}
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\item Have students enroll in course on TaskStream
	\item Review Surprise Journal, connect with readings
\end{dayact}
\begin{dayref}
	\item Have students write first entry in Surprise Journal on TaskStream
\end{dayref}
\end{weeksched}
